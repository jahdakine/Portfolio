...
<div id="list">
	...
	<div id="t1"><!-- // removed for carousel -->	
		...
		<li class="block1">
			<a href="/users" title="You must be logged in to access" onclick="return false;">Yelp<span class="listImg"><br/><img src="/img/yelp-icon.png" height="128px" width="128px" /></span></a>
		</li>
		<li class="block1">
			<a href="/users" title="You must be logged in to access" onclick="return false;">iCloud<span class="listImg"><br/><img src="/img/mobileme-icon.png" height="128px" width="128px" /></span></a>
		</li>
		<li class="block1">
			<a href="/users" title="You must be logged in to access" onclick="return false;">Vimeo<span class="listImg"><br/><img src="/img/vimeo-icon.png" height="128px" width="128px" /></span></a>
		</li>		
	</div><!-- // t1 -->
	<div id="t2">	
		<li class="block2">
		...
		<li class="block2">
			<a href="/users" title="You must be logged in to access" onclick="return false;">Evernote<span class="listImg"><br/><img src="/img/evernote-icon.png" height="128px" width="128px" /></span></a>
		</li>
		<li class="block2">
			<a href="/users" title="You must be logged in to access" onclick="return false;">Picassa<span class="listImg"><br/><img src="/img/picasa-icon.png" height="128px" width="128px" /></span></a>
		</li>		
		<li class="block2">
			<a href="/users" title="You must be logged in to access" onclick="return false;">Amazon<span class="listImg"><br/><img src="/img/amazon-icon.png" height="128px" width="128px" /></span></a>
		</li>						
	</div><!-- // t2 -->
	<div id="t3">	
		<li class="block3">
		...
		<li class="block3">
			<a href="/users" title="You must be logged in to access" onclick="return false;">PayPal<span class="listImg"><br/><img src="/img/paypal-icon.png" height="128px" width="128px" /></span></a>
		</li>
		<li class="block3">
			<a href="/users" title="You must be logged in to access" onclick="return false;">Skype<span class="listImg"><br/><img src="/img/skype-icon.png" height="128px" width="128px" /></span></a>
		</li>	
		<li class="block3">
			<a href="/users" title="You must be logged in to access" onclick="return false;">Gmail<span class="listImg"><br/><img src="/img/gmail-icon.png" height="128px" width="128px" /></span></a>
		</li>		
	</div><!-- // t3 -->
	</ul>
</div><!-- // list -->
	...
	<div id="landing">
		...
		<section class="notes">
			...
			<ul>
				...
				<li><strike>Remove arrow from Flickr imgs</strike></li>	
				...
				<li>Animate logo with Canvas JS? Really?</li>
