...
<section>
	...
	<ul class="nolist">
		...
		<li>
			{{ HTML::a_img('skype:jahdakine?call', "Skype call (best to email first - I don't camp out there)", 'Open Skype', '/img/skype-sm-icon.png', '', array('target' => '_blank' ,"style" => "vertical-align:middle"), array("style" => "vertical-align:bottom"), true) }}
		</li>
	</ul>
	<p>
...
<section id="helper" class="hidden">
	...
	<ul class="nolist">
		...
		<li>
			{{ HTML::a_img('http://support.google.com/chrome/bin/answer.py?hl=en&amp;answer=95472', 'Chrome', 'Open help for Chrome popups in a new window/tab', '/img/chrome-icon.png', '', array('target' => '_blank', "style" => "vertical-align:middle"), array("style" => "vertical-align:bottom"), true) }}
		</li>
		<li>
			{{ HTML::a_img('http://www.apple.com/safari/features.html#security', 'Safari', 'Open help for Safari popups in a new window/tab', '/img/safari-icon.png', '', array('target' => '_blank', "style" => "vertical-align:middle"), array("style" => "vertical-align:bottom"), true) }}	
		</li>			
		<li>
		{{ HTML::a_img('http://www.opera.com/browser/tutorials/personalize/content/#popups', 'Opera', 'Open help for Opera popups in a new window/tab', '/img/opera-icon.png', '', array('target' => '_blank' ,"style" => "vertical-align:middle"), array("style" => "vertical-align:bottom"), true) }}	
		</li>
		<li>
			{{ HTML::a_img('http://windows.microsoft.com/en-US/Windows7/Internet-Explorer-Pop-up-Blocker-frequently-asked-questions', 'Internet Explorer', 'Open help for Internet Explorer popups in a new window/tab', '/img/ie-icon.png', '', array('target' => '_blank' ,"style" => "vertical-align:middle"), array("style" => "vertical-align:bottom"), true) }}	
		</li>
	</ul>
</section>
@endsection
