...
<section id="communicate">
	...
	<a id="help" href="#" title="Help with popups"><img class="to-middle" width="16" height="19" alt="" src="http://laravel.dev:8888/img/help-icon.png" /></a>	
...
<section id="helper" class="hidden">
	...
	<ul class="nolist">
		<li>
			<a class="to-middle offsite" target="_blank" href="http://support.mozilla.org/en-US/kb/pop-blocker-settings-exceptions-troubleshooting" title="Open help for Firefox popups in a new window/tab"><img class="to-bottom" width="32" height="32" alt="" src="http://laravel.dev:8888/img/firefox-icon.png">&nbsp;Firefox</a>
		...
		<li>
			<a class="to-middle offsite" target="_blank" href="http://support.google.com/chrome/bin/answer.py?hl=en&answer=95472" title="Open help for Chrome popups in a new window/tab"><img class="to-bottom" width="32" height="32" alt="" src="http://laravel.dev:8888/img/chrome-icon.png">&nbsp;Chrome</a>
		...
		<li>
			<a class="to-middle offsite" target="_blank" href="http://www.apple.com/safari/features.html#security" title="Open help for Safari popups in a new window/tab"><img class="to-bottom" width="32" height="32" alt="" src="http://laravel.dev:8888/img/safari-icon.png">&nbsp;Safari</a>
		...
		<li>
			<a class="to-middle offsite" target="_blank" href="http://www.opera.com/browser/tutorials/personalize/content/#popups" title="Open help for Opera popups in a new window/tab"><img class="to-bottom" width="32" height="32" alt="" src="http://laravel.dev:8888/img/opera-icon.png">&nbsp;Opera</a>
		...
		<li>
			<a class="to-middle offsite" target="_blank" href="http://windows.microsoft.com/en-US/Windows7/Internet-Explorer-Pop-up-Blocker-frequently-asked-questions" title="Open help for Internet Explorer popups in a new window/tab"><img class="to-bottom" width="32" height="32" alt="" src="http://laravel.dev:8888/img/ie-icon.png">&nbsp;Internet Explorer</a>
