...
<section id="helper" class="hidden">
	...
	<ul class="nolist">
		<li>
			{{ HTML::a_img('http://support.mozilla.org/en-US/kb/pop-blocker-settings-exceptions-troubleshooting', 'Firefox', 'Open help for Firefox popups in a new window/tab', '/img/firefox-icon.png', '', array('target' => '_blank', "class" => "to-middle"), array('class' => 'to-bottom', "width" => "32", "height" => "32"), true) }}
		</li>
		<li>
			{{ HTML::a_img('http://support.google.com/chrome/bin/answer.py?hl=en&amp;answer=95472', 'Chrome', 'Open help for Chrome popups in a new window/tab', '/img/chrome-icon.png', '', array('target' => '_blank', "class" => "to-middle"), array('class' => 'to-bottom', "width" => "32", "height" => "32"), true) }}
		</li>
		<li>
			{{ HTML::a_img('http://www.apple.com/safari/features.html#security', 'Safari', 'Open help for Safari popups in a new window/tab', '/img/safari-icon.png', '', array('target' => '_blank', "class" => "to-middle"), array('class' => 'to-bottom', "width" => "32", "height" => "32"), true) }}	
		</li>			
		<li>
			{{ HTML::a_img('http://www.opera.com/browser/tutorials/personalize/content/#popups', 'Opera', 'Open help for Opera popups in a new window/tab', '/img/opera-icon.png', '', array('target' => '_blank' ,"class" => "to-middle"), array('class' => 'to-bottom', "width" => "32", "height" => "32"), true) }}	
		</li>
		<li>
			{{ HTML::a_img('http://windows.microsoft.com/en-US/Windows7/Internet-Explorer-Pop-up-Blocker-frequently-asked-questions', 'Internet Explorer', 'Open help for Internet Explorer popups in a new window/tab', '/img/ie-icon.png', '', array('target' => '_blank' ,"class" => "to-middle"), array('class' => 'to-bottom', "width" => "32", "height" => "32"), true) }}	
		</li>
	</ul>
</section><!-- // helper -->
@endsection<!-- // main -->
